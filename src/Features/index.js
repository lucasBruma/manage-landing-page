...
function Features({hideBgFeatureTitle}) {
    return ( 
        <Stack 
            ...
            py='3rem'
            position='relative'
            _after={{content:"''", background:[`center/55% no-repeat url(${imgBg})`,null,`center/38% no-repeat url(${imgBg})`] , position: 'absolute',left:['32%',null,'-48%'] ,top:['-117%',null,'79px'],zIndex: '-2', width:['145%',null,'91%'] , height:'178%'}}
        >
            <VStack 
                ...
                <Box 
                    ...
                    fontWeight='700' 
                    lineHeight='1.1'
                >What’s different about Manage?</Box>
                <Box 
                    maxWidth={['100%','70%']} 
                    color='blue.light'
