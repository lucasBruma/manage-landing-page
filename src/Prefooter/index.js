...
function Prefooter() {
    return ( 
        <Stack 
            ...
            position='relative'
            _before={{content:"''", background:[`0 17%/23% no-repeat url(${imgBgMobile})`,null,`20px/114% no-repeat url(${imgBg})`], 
        ...
        >
            ...
            >Simplify how your team works today.</Box>
            <Button variant='bgLight' mt='3rem'>Get Started</Button>
        </Stack>
    );
}
