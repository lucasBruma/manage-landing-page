        ...
        <form onSubmit={handleSubmit(onSubmit)} noValidate>
            ...
            >
                ...
                { !errors.email && isClicked ? (
                    <Box position='absolute' zIndex='100' top='60px' color='green.400'>Good! Your email address looks valid.</Box>
                ) : (
                ...
                <Button type='submit' variant='solid' onClick={onClick} marginLeft='1rem'>Go</Button>  
            </FormControl> 
        </form>
